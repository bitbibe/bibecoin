...
#   c) node1 mines 32 blocks, so now node 0 has 60001BIBE, node 1 has 4250BIBE, node2 has none.
#   d) node0 sends 601 BIBE to node2, in two transactions (301 BIBE, then 300 BIBE).
