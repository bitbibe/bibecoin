...
In order to support loading of multiple wallets in bibecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bibecoin.cpp.
...
Changes to bibecoin.cpp
----------------------
bibecoin.cpp is the entry point into bibecoin-qt, and as such, will require some minor modifications to provide hooks for
