...
VERSION=
commit=false
url=https://github.com/bitbibe/bibecoin
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the bibecoin, gitian-builder, gitian.sigs, and bibecoin-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/bitbibe/Bibecoin
...
then
	# Make output folder
        mkdir -p "./bibecoin-binaries/${VERSION}"
	...
	then
	    ...
	    echo ""
            ./bin/gbuild -j ${proc} -m ${mem} --commit bibecoin=${COMMIT} --url bibecoin=${url} ../bibecoin/contrib/gitian-descriptors/gitian-linux.yml
            ...
            mv build/out/bibecoin-*.tar.gz build/out/src/bibecoin-*.tar.gz ../bibecoin-binaries/${VERSION}
	fi
	# Windows
	if [[ $windows = true ]]
	then
	    ...
	    echo ""
            ./bin/gbuild -j ${proc} -m ${mem} --commit bibecoin=${COMMIT} --url bibecoin=${url} ../bibecoin/contrib/gitian-descriptors/gitian-win.yml
            ...
            mv build/out/bibecoin-*.zip build/out/bibecoin-*.exe ../bibecoin-binaries/${VERSION}
	fi
	# Mac OSX
	if [[ $osx = true ]]
	then
	    ...
	    echo ""
            ./bin/gbuild -j ${proc} -m ${mem} --commit bibecoin=${COMMIT} --url bibecoin=${url} ../bibecoin/contrib/gitian-descriptors/gitian-osx.yml
            ...
            mv build/out/bibecoin-*.tar.gz build/out/bibecoin-*.dmg ../bibecoin-binaries/${VERSION}
	fi
	# AArch64
	if [[ $aarch64 = true ]]
	then
	    ...
	    echo ""
            ./bin/gbuild -j ${proc} -m ${mem} --commit bibecoin=${COMMIT} --url bibecoin=${url} ../bibecoin/contrib/gitian-descriptors/gitian-aarch64.yml
            ./bin/gsign --signer $SIGNER --release ${VERSION}-aarch64 --destination ../gitian.sigs/ ../bibecoin/contrib/gitian-descriptors/gitian-aarch64.yml
            mv build/out/bibecoin-*.tar.gz build/out/src/bibecoin-*.tar.gz ../bibecoin-binaries/${VERSION}
	fi
	popd || exit
...
then
	...
	then
	    ...
	    echo ""
            ./bin/gbuild -i --commit signature=${COMMIT} ../bibecoin/contrib/gitian-descriptors/gitian-win-signer.yml
            ...
            mv build/out/bibecoin-*win64-setup.exe ../bibecoin-binaries/${VERSION}
            mv build/out/bibecoin-*win32-setup.exe ../bibecoin-binaries/${VERSION}
	fi
	# Sign Mac OSX
	if [[ $osx = true ]]
	then
	    ...
	    echo ""
            ./bin/gbuild -i --commit signature=${COMMIT} ../bibecoin/contrib/gitian-descriptors/gitian-osx-signer.yml
            ...
            mv build/out/bibecoin-osx-signed.dmg ../bibecoin-binaries/${VERSION}/bibecoin-${VERSION}-osx.dmg
	fi
	popd || exit
