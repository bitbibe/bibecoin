...
RESOURCES += src/qt/bibecoin.qrc src/qt/bibecoin_locale.qrc

TRANSLATIONS += src/qt/locale/bibecoin_bg.ts \
                src/qt/locale/bibecoin_de.ts \
                src/qt/locale/bibecoin_en.ts \
                src/qt/locale/bibecoin_es.ts \
                src/qt/locale/bibecoin_fi.ts \
                src/qt/locale/bibecoin_fr.ts \
                src/qt/locale/bibecoin_it.ts \
                src/qt/locale/bibecoin_ja.ts \
                src/qt/locale/bibecoin_pl.ts \
                src/qt/locale/bibecoin_pt.ts \
                src/qt/locale/bibecoin_ru.ts \
                src/qt/locale/bibecoin_sk.ts \
                src/qt/locale/bibecoin_sv.ts \
                src/qt/locale/bibecoin_vi.ts \
                src/qt/locale/bibecoin_zh_CN.ts \
                src/qt/locale/bibecoin_zh_TW.ts
