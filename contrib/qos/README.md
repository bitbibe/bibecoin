...
This means one can have an always-on bibecoind instance running, and another local bibecoind/bibecoin-qt instance which connects to this node and receives blocks from it.
