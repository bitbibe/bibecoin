...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BibeCoin Core bibecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bibecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bibecoin transaction") + "\n" +
                               "  bibecoin-tx [options] -create [commands]   " + _("Create hex-encoded bibecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bibecoin transaction
