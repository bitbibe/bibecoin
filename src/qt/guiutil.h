...
/** Utility functions used by the BibeCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render BibeCoin addresses in monospace font
...
// Parse "bibecoin:" URI into recipient object, return true on successful parsing
