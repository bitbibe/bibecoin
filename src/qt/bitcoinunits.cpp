...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(BIBE);
    unitlist.append(mBIBE);
    unitlist.append(uBIBE);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case BIBE:
        return QString("bibecoin");
    case mBIBE:
        return QString("mbibecoin");
    case uBIBE:
        return QString::fromUtf8("ubibecoin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case BIBE:
            return QString("BIBE");
        case mBIBE:
            return QString("mBIBE");
        case uBIBE:
            return QString::fromUtf8("μBIBE");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case BIBE:
            return QString("tBIBE");
        case mBIBE:
            return QString("mtBIBE");
        case uBIBE:
            return QString::fromUtf8("μtBIBE");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case BIBE:
            return QString("BIBE");
        case mBIBE:
            return QString("Milli-BIBE (1 / 1" THIN_SP_UTF8 "000)");
        case uBIBE:
            return QString("Micro-BIBE (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case BIBE:
            return QString("TestBIBEs");
        case mBIBE:
            return QString("Milli-TestBIBE (1 / 1" THIN_SP_UTF8 "000)");
        case uBIBE:
            return QString("Micro-TestBIBE (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
