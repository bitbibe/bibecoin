                                          ...
                                          banTableContextMenu(0)
{
    ...
    if(!strzphrPathCustom.empty()) {
        ui->wallet_customzbibebackuppath->setText(QString::fromStdString(strzphrPathCustom));
        ui->wallet_customzbibebackuppath_label->setVisible(true);
        ui->wallet_customzbibebackuppath->setVisible(true);
    }
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BibeCoin RPC console.") + "<br>" +
