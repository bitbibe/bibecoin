 ...
 */
    ...
    typeWidget->addItem(tr("Received BIBE from zBIBE"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBIBE"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBIBE));
