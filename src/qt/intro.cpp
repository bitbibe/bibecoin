...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BibeCoin Core"),
     ...
     * override -datadir in the bibecoin.conf file in the default data directory
     * (to be consistent with bibecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
