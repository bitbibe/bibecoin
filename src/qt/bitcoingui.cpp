                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BibeCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BibeCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bibecoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBIBE"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About bibecoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about BibeCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BibeCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BibeCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BibeCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a BibeCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BibeCoin Core help message to get a list with possible BibeCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BibeCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BibeCoin network", "", count));
}
...
{
    QString strTitle = tr("BibeCoin Core"); // default title
