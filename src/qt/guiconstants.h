...
/* BibeCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BibeCoin"
#define QAPP_ORG_DOMAIN "bitbibe.io"
#define QAPP_APP_NAME_DEFAULT "BibeCoin-Qt"
#define QAPP_APP_NAME_TESTNET "BibeCoin-Qt-testnet"
