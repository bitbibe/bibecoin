...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (     0, uint256("00000f8208476d41d9dc8b4b0f9ef281d89959b96eb746d92bd3f659f3aacd2e"));
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Bibecoin: 1 day
        nTargetSpacing = 1 * 60;  // Bibecoin: 1 minute
        nMaturity = 50;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "The first decentralized WALLET and EXCHANGE for BITCOINCORE";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1539166210;
        genesis.nBits = 0x1e0ffff0;;
        genesis.nNonce = 2494366;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x1dc9918bd26496c498b65a39b178c69e10ddf22a7eaf3e726509febe93028bf9"));
        assert(genesis.hashMerkleRoot == uint256("0x3b78d73ee13ac1278c1b62bfbc4c2321e08a0648f6cf161c499bf05ffbd1c3d2"));

        vSeeds.push_back(CDNSSeedData("0", "45.77.255.121"));
        vSeeds.push_back(CDNSSeedData("1", "66.42.51.122"));
        vSeeds.push_back(CDNSSeedData("2", "66.42.48.124"));
        vSeeds.push_back(CDNSSeedData("3", "45.77.253.110"));
        ...
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x00)(0x01)(0x79).convert_to_container<std::vector<unsigned char> >();
        ...
        strObfuscationPoolDummyAddress = "BP2rYfVgw6rp6Fw6hKzjXg1eNuTEuVfB4Q";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // bibecoin: 1 day
        nTargetSpacing = 1 * 10;  // bibecoin: 1 minute
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet bibecoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet bibecoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet bibecoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet bibecoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet bibecoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Bibecoin: 1 day
        nTargetSpacing = 1 * 60;        // Bibecoin: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
