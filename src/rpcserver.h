...
/**
 * BibeCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzbibeseed(const UniValue& params, bool fHelp);
extern UniValue getzbibeseed(const UniValue& params, bool fHelp);
