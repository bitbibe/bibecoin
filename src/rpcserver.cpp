...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BibeCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "BibeCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BibeCoin features */
        {"bibecoin", "masternode", &masternode, true, true, false},
        {"bibecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"bibecoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bibecoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bibecoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bibecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bibecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bibecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bibecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"bibecoin", "startmasternode", &startmasternode, true, true, false},
        {"bibecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bibecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bibecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bibecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bibecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bibecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bibecoin", "mnbudget", &mnbudget, true, true, false},
        {"bibecoin", "preparebudget", &preparebudget, true, true, false},
        {"bibecoin", "submitbudget", &submitbudget, true, true, false},
        {"bibecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bibecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bibecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bibecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bibecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bibecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bibecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bibecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"bibecoin", "mnsync", &mnsync, true, true, false},
        {"bibecoin", "spork", &spork, true, true, false},
        {"bibecoin", "getpoolinfo", &getpoolinfo, true, true, false},
        {"bibecoin", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
        ...
        {"zerocoin", "getzbibeseed", &getzbibeseed, false, false, true},
        {"zerocoin", "setzbibeseed", &setzbibeseed, false, false, true}
...
{
    return "> bibecoin-cli " + methodname + " " + args + "\n";
}
