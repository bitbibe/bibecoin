Contributing to BibeCoin Core
============================

The BibeCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BibeCoin Core project, and is not to be
confused with overall BibeCoin Network Protocol consensus changes.

Whether a pull request is merged into BibeCoin Core rests with the project merge
...
Patches that change BibeCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the BibeCoin consensus, it must have been
...
The project leader is the release manager for each BibeCoin Core release.
